/**
 * This component is copied and modified from
 * https://www.npmjs.com/package/piano-keys-webcomponent-v0
 * it's a pretty great component, but getting pretty dated, and not so great for extending which I need to do here
 */

import {Note, noteGenerator} from "./note-generator.js";
